...
const GAME_DATA = {
  ...
  relatives: [
    ...
    // ── 扩展亲戚（地狱模式用） ──
    { id: 'uncle_doctor', name: '方大伯', title: '方大伯', relation: '爸爸的堂兄', type: '长辈_男', traits: ['医生', '养生达人'], traitKeywords: ['健康', '养生', '体检'], questionTags: ['传统寒暄', '生活方式'], avatar: '👨‍⚕️', avatarBg: 'linear-gradient(135deg, #1A4A3A, #2A6A5A)' },
    { id: 'aunt_teacher', name: '孔阿姨', title: '孔阿姨', relation: '妈妈的同学', type: '长辈_女', traits: ['退休教师', '爱说教'], traitKeywords: ['教育', '读书', '上进'], questionTags: ['职业收入', '传统寒暄'], avatar: '👩‍🏫', avatarBg: 'linear-gradient(135deg, #3A2A1A, #5A4A3A)' },
    { id: 'uncle_chef', name: '谢大厨', title: '谢叔', relation: '爸爸的战友', type: '长辈_男', traits: ['厨师', '美食家'], traitKeywords: ['做菜', '美食', '手艺'], questionTags: ['传统寒暄', '生活方式'], avatar: '👨‍🍳', avatarBg: 'linear-gradient(135deg, #5A2A0A, #8A4A1A)' },
    { id: 'aunt_dance', name: '田阿姨', title: '田阿姨', relation: '妈妈的广场舞友', type: '长辈_女', traits: ['广场舞达人', '热情奔放'], traitKeywords: ['跳舞', '锻炼', '快乐'], questionTags: ['传统寒暄', '社交热点'], avatar: '💃', avatarBg: 'linear-gradient(135deg, #6A1A4A, #9A2A6A)' },
    { id: 'uncle_driver', name: '曹叔叔', title: '曹叔', relation: '爸爸的邻居', type: '长辈_男', traits: ['出租车司机', '见多识广'], traitKeywords: ['开车', '路况', '见闻'], questionTags: ['社交热点', '传统寒暄'], avatar: '🚕', avatarBg: 'linear-gradient(135deg, #4A4A0A, #6A6A1A)' },
    { id: 'aunt_nurse', name: '白阿姨', title: '白阿姨', relation: '妈妈的表姐', type: '长辈_女', traits: ['护士', '细心'], traitKeywords: ['医院', '照顾', '健康'], questionTags: ['传统寒暄', '催婚催生'], avatar: '👩‍⚕️', avatarBg: 'linear-gradient(135deg, #1A3A5A, #2A5A7A)' },
    { id: 'uncle_farmer', name: '老李头', title: '李伯', relation: '爸爸的远房堂兄', type: '长辈_男', traits: ['种地大户', '朴实'], traitKeywords: ['庄稼', '收成', '土地'], questionTags: ['传统寒暄', '生活方式'], avatar: '👨‍🌾', avatarBg: 'linear-gradient(135deg, #2A4A1A, #4A6A2A)' },
    { id: 'aunt_tailor', name: '蒋婶', title: '蒋婶', relation: '妈妈的邻居', type: '长辈_女', traits: ['裁缝', '手巧'], traitKeywords: ['衣服', '手工', '缝纫'], questionTags: ['传统寒暄', '生活方式'], avatar: '🧵', avatarBg: 'linear-gradient(135deg, #5A1A2A, #7A3A4A)' },
    { id: 'cousin_brother_lawyer', name: '何堂哥', title: '何堂哥', relation: '大伯的外甥', type: '同辈_男', traits: ['律师', '能言善辩'], traitKeywords: ['法律', '官司', '维权'], questionTags: ['职业收入', '社交热点'], avatar: '⚖️', avatarBg: 'linear-gradient(135deg, #2A2A3A, #4A4A5A)' },
    { id: 'cousin_sister_doctor', name: '林表姐', title: '林表姐', relation: '姑父的侄女', type: '同辈_女', traits: ['牙医', '收入高'], traitKeywords: ['牙齿', '健康', '诊所'], questionTags: ['职业收入', '攀比'], avatar: '🦷', avatarBg: 'linear-gradient(135deg, #1A4A4A, #2A6A6A)' },
    { id: 'uncle_chess', name: '范大爷', title: '范大爷', relation: '爷爷的棋友', type: '长辈_男', traits: ['象棋高手', '爱下棋'], traitKeywords: ['象棋', '动脑', '策略'], questionTags: ['传统寒暄', '社交热点'], avatar: '♟️', avatarBg: 'linear-gradient(135deg, #3A3A2A, #5A5A4A)' },
    { id: 'aunt_mahjong', name: '丁婶', title: '丁婶', relation: '奶奶的牌友', type: '长辈_女', traits: ['麻将高手', '爱打牌'], traitKeywords: ['麻将', '手气', '牌技'], questionTags: ['传统寒暄', '社交热点'], avatar: '🀄', avatarBg: 'linear-gradient(135deg, #4A1A1A, #6A3A3A)' },
    { id: 'cousin_brother_streamer', name: '韩表弟', title: '韩表弟', relation: '二姨的儿子', type: '同辈_男', traits: ['游戏主播', '宅男'], traitKeywords: ['直播', '游戏', '粉丝'], questionTags: ['社交热点', '职业收入'], avatar: '🎮', avatarBg: 'linear-gradient(135deg, #1A1A4A, #3A3A6A)' },
    { id: 'cousin_sister_teacher', name: '沈表妹', title: '沈表妹', relation: '三姨的外甥女', type: '同辈_女', traits: ['幼师', '有耐心'], traitKeywords: ['小朋友', '教育', '幼儿园'], questionTags: ['职业收入', '催婚催生'], avatar: '🧸', avatarBg: 'linear-gradient(135deg, #5A2A4A, #7A4A6A)' },
    { id: 'uncle_contractor', name: '魏老板', title: '魏叔', relation: '爸爸的生意伙伴', type: '长辈_男', traits: ['包工头', '有钱'], traitKeywords: ['工地', '赚钱', '项目'], questionTags: ['职业收入', '攀比'], avatar: '🏗️', avatarBg: 'linear-gradient(135deg, #4A3A1A, #6A5A2A)' },
    { id: 'aunt_realtor', name: '龚阿姨', title: '龚阿姨', relation: '妈妈的牌友', type: '长辈_女', traits: ['房产中介', '能说会道'], traitKeywords: ['房子', '买房', '投资'], questionTags: ['生活方式', '攀比'], avatar: '🏠', avatarBg: 'linear-gradient(135deg, #3A1A2A, #5A3A4A)' },
    { id: 'cousin_brother_fitness', name: '彭表哥', title: '彭表哥', relation: '舅舅的外甥', type: '同辈_男', traits: ['健身教练', '肌肉男'], traitKeywords: ['健身', '蛋白粉', '增肌'], questionTags: ['生活方式', '社交热点'], avatar: '💪', avatarBg: 'linear-gradient(135deg, #2A3A2A, #4A5A4A)' },
    { id: 'cousin_sister_art', name: '苏表姐', title: '苏表姐', relation: '大姑的外甥女', type: '同辈_女', traits: ['画家', '文艺'], traitKeywords: ['画画', '艺术', '展览'], questionTags: ['社交热点', '生活方式'], avatar: '🎨', avatarBg: 'linear-gradient(135deg, #4A1A5A, #6A3A7A)' },
    { id: 'uncle_retired', name: '老郭', title: '郭伯', relation: '爸爸的老领导', type: '长辈_男', traits: ['退休干部', '爱忆当年'], traitKeywords: ['当年', '单位', '退休'], questionTags: ['传统寒暄', '职业收入'], avatar: '🎖️', avatarBg: 'linear-gradient(135deg, #3A2A1A, #5A4A2A)' },
    { id: 'aunt_insurance', name: '贺阿姨', title: '贺阿姨', relation: '妈妈的远房表妹', type: '长辈_女', traits: ['卖保险', '话多'], traitKeywords: ['保险', '理财', '保障'], questionTags: ['职业收入', '生活方式'], avatar: '📋', avatarBg: 'linear-gradient(135deg, #2A3A4A, #4A5A6A)' },
    { id: 'cousin_brother_phd', name: '高博士', title: '高表哥', relation: '姑父的侄子', type: '同辈_男', traits: ['博士在读', '书呆子'], traitKeywords: ['论文', '科研', '实验室'], questionTags: ['职业收入', '社交热点'], avatar: '🔬', avatarBg: 'linear-gradient(135deg, #1A2A3A, #3A4A5A)' },
    { id: 'cousin_sister_nurse', name: '叶表妹', title: '叶表妹', relation: '舅妈的侄女', type: '同辈_女', traits: ['护士', '温柔'], traitKeywords: ['医院', '值班', '病人'], questionTags: ['职业收入', '催婚催生'], avatar: '💉', avatarBg: 'linear-gradient(135deg, #1A4A5A, #2A6A7A)' },
    { id: 'uncle_taxi', name: '秦师傅', title: '秦叔', relation: '爸爸的初中同学', type: '长辈_男', traits: ['网约车司机', '健谈'], traitKeywords: ['跑车', '收入', '乘客'], questionTags: ['职业收入', '社交热点'], avatar: '🚗', avatarBg: 'linear-gradient(135deg, #3A3A1A, #5A5A3A)' },
    { id: 'aunt_beauty', name: '施阿姨', title: '施阿姨', relation: '妈妈的高中同学', type: '长辈_女', traits: ['美容院老板', '爱美'], traitKeywords: ['美容', '护肤', '保养'], questionTags: ['生活方式', '社交热点'], avatar: '💅', avatarBg: 'linear-gradient(135deg, #5A1A4A, #7A3A6A)' },
    { id: 'cousin_brother_cook', name: '吕表弟', title: '吕表弟', relation: '二叔的外甥', type: '同辈_男', traits: ['厨师学徒', '贪吃'], traitKeywords: ['做菜', '美食', '学艺'], questionTags: ['传统寒暄', '生活方式'], avatar: '🍜', avatarBg: 'linear-gradient(135deg, #5A3A0A, #7A5A2A)' },
    { id: 'cousin_sister_flight', name: '许表姐', title: '许表姐', relation: '大姑的儿媳的妹妹', type: '同辈_女', traits: ['空姐', '见多识广'], traitKeywords: ['飞机', '旅行', '国外'], questionTags: ['社交热点', '攀比'], avatar: '✈️', avatarBg: 'linear-gradient(135deg, #1A2A5A, #3A4A7A)' },
    { id: 'uncle_vet', name: '卫叔叔', title: '卫叔', relation: '爸爸的表哥', type: '长辈_男', traits: ['兽医', '爱动物'], traitKeywords: ['宠物', '动物', '看病'], questionTags: ['传统寒暄', '生活方式'], avatar: '🐾', avatarBg: 'linear-gradient(135deg, #2A4A2A, #4A6A4A)' },
    { id: 'aunt_accountant', name: '冯婶', title: '冯婶', relation: '妈妈的堂姐', type: '长辈_女', traits: ['会计', '精打细算'], traitKeywords: ['算账', '省钱', '理财'], questionTags: ['职业收入', '生活方式'], avatar: '🧮', avatarBg: 'linear-gradient(135deg, #3A2A3A, #5A4A5A)' },
    { id: 'cousin_brother_music', name: '宋表弟', title: '宋表弟', relation: '三姨的儿子', type: '同辈_男', traits: ['乐队吉他手', '文艺青年'], traitKeywords: ['音乐', '乐队', '演出'], questionTags: ['社交热点', '职业收入'], avatar: '🎸', avatarBg: 'linear-gradient(135deg, #4A1A2A, #6A3A4A)' },
    { id: 'cousin_sister_baker', name: '唐表妹', title: '唐表妹', relation: '姨妈的女儿', type: '同辈_女', traits: ['烘焙师', '甜美'], traitKeywords: ['蛋糕', '烘焙', '甜品'], questionTags: ['生活方式', '催婚催生'], avatar: '🧁', avatarBg: 'linear-gradient(135deg, #5A2A3A, #7A4A5A)' },
    { id: 'uncle_security', name: '武大叔', title: '武叔', relation: '爸爸的工友', type: '长辈_男', traits: ['保安队长', '正义感强'], traitKeywords: ['安全', '巡逻', '负责'], questionTags: ['传统寒暄', '职业收入'], avatar: '🛡️', avatarBg: 'linear-gradient(135deg, #2A2A4A, #4A4A6A)' },
    { id: 'aunt_kindergarten', name: '程阿姨', title: '程阿姨', relation: '妈妈的邻居', type: '长辈_女', traits: ['幼儿园园长', '慈祥'], traitKeywords: ['小孩', '教育', '成长'], questionTags: ['催婚催生', '传统寒暄'], avatar: '🌸', avatarBg: 'linear-gradient(135deg, #5A2A2A, #7A4A4A)' },
    { id: 'cousin_brother_delivery', name: '郝表哥', title: '郝表哥', relation: '二叔的女婿的弟弟', type: '同辈_男', traits: ['外卖骑手', '勤劳'], traitKeywords: ['送餐', '跑单', '辛苦'], questionTags: ['职业收入', '生活方式'], avatar: '🛵', avatarBg: 'linear-gradient(135deg, #4A3A2A, #6A5A4A)' },
    { id: 'cousin_sister_design', name: '戴表妹', title: '戴表妹', relation: '舅舅的女婿的妹妹', type: '同辈_女', traits: ['室内设计师', '有品味'], traitKeywords: ['装修', '设计', '审美'], questionTags: ['生活方式', '职业收入'], avatar: '🏡', avatarBg: 'linear-gradient(135deg, #3A2A4A, #5A4A6A)' },
    { id: 'uncle_barber', name: '汤师傅', title: '汤叔', relation: '爸爸的理发师', type: '长辈_男', traits: ['理发师', '话痨'], traitKeywords: ['发型', '时尚', '剪头'], questionTags: ['社交热点', '传统寒暄'], avatar: '💇', avatarBg: 'linear-gradient(135deg, #4A2A3A, #6A4A5A)' },
    { id: 'aunt_yoga', name: '于阿姨', title: '于阿姨', relation: '妈妈的瑜伽老师', type: '长辈_女', traits: ['瑜伽教练', '养生'], traitKeywords: ['瑜伽', '冥想', '健康'], questionTags: ['生活方式', '传统寒暄'], avatar: '🧘‍♀️', avatarBg: 'linear-gradient(135deg, #2A4A3A, #4A6A5A)' },
    { id: 'cousin_brother_realtor', name: '任表哥', title: '任表哥', relation: '大伯的女婿', type: '同辈_男', traits: ['房产销售', '油嘴滑舌'], traitKeywords: ['卖房', '楼盘', '提成'], questionTags: ['生活方式', '职业收入'], avatar: '🏢', avatarBg: 'linear-gradient(135deg, #3A3A3A, #5A5A5A)' },
    { id: 'cousin_sister_vet', name: '毛表妹', title: '毛表妹', relation: '姑父的外甥女', type: '同辈_女', traits: ['宠物店老板', '爱猫'], traitKeywords: ['猫咪', '宠物', '萌宠'], questionTags: ['生活方式', '社交热点'], avatar: '🐱', avatarBg: 'linear-gradient(135deg, #4A3A1A, #6A5A3A)' },
    { id: 'uncle_electrician', name: '雷师傅', title: '雷叔', relation: '爸爸的远房表兄', type: '长辈_男', traits: ['电工', '手艺人'], traitKeywords: ['电路', '修理', '手艺'], questionTags: ['传统寒暄', '职业收入'], avatar: '⚡', avatarBg: 'linear-gradient(135deg, #4A4A1A, #6A6A3A)' },
    { id: 'aunt_florist', name: '花婶', title: '花婶', relation: '妈妈的远房表姐', type: '长辈_女', traits: ['花店老板', '浪漫'], traitKeywords: ['鲜花', '浪漫', '节日'], questionTags: ['催婚催生', '生活方式'], avatar: '💐', avatarBg: 'linear-gradient(135deg, #5A1A3A, #7A3A5A)' },
    { id: 'cousin_brother_driver', name: '马表哥', title: '马表哥', relation: '舅舅的连襟的儿子', type: '同辈_男', traits: ['货车司机', '豪爽'], traitKeywords: ['跑长途', '运货', '辛苦'], questionTags: ['职业收入', '传统寒暄'], avatar: '🚛', avatarBg: 'linear-gradient(135deg, #3A2A2A, #5A4A4A)' },
    { id: 'cousin_sister_hr', name: '钟表姐', title: '钟表姐', relation: '大姑的儿媳', type: '同辈_女', traits: ['HR', '爱八卦'], traitKeywords: ['招聘', '面试', '跳槽'], questionTags: ['职业收入', '催婚催生'], avatar: '📊', avatarBg: 'linear-gradient(135deg, #2A2A4A, #4A4A6A)' },
    { id: 'uncle_plumber', name: '管师傅', title: '管叔', relation: '爸爸的老乡', type: '长辈_男', traits: ['水管工', '实在'], traitKeywords: ['修水管', '装修', '手艺'], questionTags: ['传统寒暄', '生活方式'], avatar: '🔧', avatarBg: 'linear-gradient(135deg, #2A3A3A, #4A5A5A)' },
    { id: 'aunt_matchmaker2', name: '媒婆张', title: '张婶', relation: '村里的媒婆', type: '长辈_女', traits: ['专业媒婆', '嘴甜'], traitKeywords: ['说媒', '相亲', '姻缘'], questionTags: ['催婚催生', '攀比'], avatar: '💘', avatarBg: 'linear-gradient(135deg, #6A1A2A, #8A3A4A)' },
    { id: 'cousin_brother_trader', name: '金表弟', title: '金表弟', relation: '二姨的外甥', type: '同辈_男', traits: ['炒股达人', '爱冒险'], traitKeywords: ['股票', '基金', '投资'], questionTags: ['社交热点', '职业收入'], avatar: '📈', avatarBg: 'linear-gradient(135deg, #1A4A1A, #3A6A3A)' },
    { id: 'cousin_sister_writer', name: '文表妹', title: '文表妹', relation: '三姨的外甥女', type: '同辈_女', traits: ['网文作者', '宅女'], traitKeywords: ['写小说', '网文', '稿费'], questionTags: ['社交热点', '职业收入'], avatar: '✍️', avatarBg: 'linear-gradient(135deg, #3A1A4A, #5A3A6A)' },
    { id: 'uncle_photographer', name: '柯叔叔', title: '柯叔', relation: '爸爸的摄影圈朋友', type: '长辈_男', traits: ['摄影师', '文艺'], traitKeywords: ['拍照', '相机', '风景'], questionTags: ['社交热点', '生活方式'], avatar: '📷', avatarBg: 'linear-gradient(135deg, #2A2A2A, #4A4A4A)' },
    { id: 'aunt_principal', name: '严校长', title: '严阿姨', relation: '妈妈的大学室友', type: '长辈_女', traits: ['中学校长', '严厉'], traitKeywords: ['成绩', '高考', '学校'], questionTags: ['职业收入', '攀比'], avatar: '🏫', avatarBg: 'linear-gradient(135deg, #2A1A3A, #4A3A5A)' },
    { id: 'cousin_brother_mechanic', name: '车表哥', title: '车表哥', relation: '姑父的外甥', type: '同辈_男', traits: ['汽修工', '爱改装'], traitKeywords: ['修车', '改装', '发动机'], questionTags: ['生活方式', '职业收入'], avatar: '🔩', avatarBg: 'linear-gradient(135deg, #3A3A2A, #5A5A4A)' },
    { id: 'cousin_sister_dancer', name: '舞表妹', title: '舞表妹', relation: '姨妈的外甥女', type: '同辈_女', traits: ['舞蹈老师', '身材好'], traitKeywords: ['跳舞', '身材', '表演'], questionTags: ['生活方式', '催婚催生'], avatar: '🩰', avatarBg: 'linear-gradient(135deg, #5A1A4A, #7A3A6A)' },
    { id: 'uncle_fisherman', name: '渔老伯', title: '渔伯', relation: '爷爷的老友', type: '长辈_男', traits: ['钓鱼达人', '有耐心'], traitKeywords: ['钓鱼', '河边', '耐心'], questionTags: ['传统寒暄', '生活方式'], avatar: '🎣', avatarBg: 'linear-gradient(135deg, #1A3A4A, #3A5A6A)' },
    { id: 'aunt_fortune', name: '仙姑', title: '仙姑', relation: '奶奶的老姐妹', type: '长辈_女', traits: ['算命先生', '神秘'], traitKeywords: ['算命', '运势', '风水'], questionTags: ['催婚催生', '社交热点'], avatar: '🔮', avatarBg: 'linear-gradient(135deg, #3A1A5A, #5A3A7A)' },
    { id: 'cousin_brother_police', name: '公表哥', title: '公表哥', relation: '二叔的女婿', type: '同辈_男', traits: ['警察', '正气'], traitKeywords: ['执法', '安全', '正义'], questionTags: ['职业收入', '传统寒暄'], avatar: '👮', avatarBg: 'linear-gradient(135deg, #1A2A4A, #3A4A6A)' },
    { id: 'cousin_sister_anchor', name: '播表姐', title: '播表姐', relation: '舅妈的侄女', type: '同辈_女', traits: ['电视主播', '端庄'], traitKeywords: ['新闻', '主持', '电视台'], questionTags: ['职业收入', '攀比'], avatar: '🎙️', avatarBg: 'linear-gradient(135deg, #4A1A3A, #6A3A5A)' }
  ],
  ...
  achievements: [
    ...
    // ── 地狱模式成就 ──
    { id: 'ach_hell_survivor', name: '九死一生', description: '地狱模式通关', icon: '☠️', conditionDesc: '地狱模式完成', condition: (s, gs) => gs.difficulty === 'hell' },
    { id: 'ach_hell_memory', name: '人形族谱', description: '地狱模式认对30+亲戚', icon: '📜', conditionDesc: '地狱模式匹配正确>=30', condition: (s, gs) => gs.difficulty === 'hell' && gs.seatingResult && gs.seatingResult.correctCount >= 30 },
    { id: 'ach_hell_memory_all', name: '最强大脑·地狱版', description: '地狱模式全部认对', icon: '🧬', conditionDesc: '地狱模式全部匹配正确', condition: (s, gs) => gs.difficulty === 'hell' && gs.seatingResult && gs.seatingResult.correctCount === 50 },
